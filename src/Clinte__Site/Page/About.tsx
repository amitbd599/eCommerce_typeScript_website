                ...
                <Col lg={7} className="right__side">
                  <div className="inner__body">
                    ...
                    <p>
                      ...
                      exercitation ullamco laboris nisi ut aliquip ex eatrl
                      commodo consequat. Duis aute irure dolor in reprehenderit
                      in voluptat velit esse cillum dolore eu fugiat nulla
                      pariatur.
                    </p>
                  ...
                  <div className="inner__body">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        Measurement (Unit: CM) Original design-100% Real Photos.
                      </li>
                      <li>
                        {" "}
                        <BsFillArrowRightCircleFill className="icon" />
                        Please allow 1-2cm (0.4-0.8") differences due to manual
                        measurement.
                      </li>
                      <li>
                        {" "}
                  ...
                  <div className="header">
                    ...
                    <div className="img__section">
                      <Row>
                        ...
                        {/* <Col lg={6} md={6} sm={12}>
                          <div className="rightImg__section">
                            <img
                              className="img-fluid"
                              src="/assets/images/about__section/about__model-6.png"
                              alt=""
                            />
                          </div>
                        </Col> */}
